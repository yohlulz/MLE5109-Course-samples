...
public class ElvisImpersonator {
    // Byte stream could not have come from real SingletonElvis instance!
    ...
    public static void main(String[] args) {
        System.out.println(new String(serializedForm));
        // Initializes ElvisStealer.impersonator and returns
        // the real SingletonElvis (which is SingletonElvis.INSTANCE)
